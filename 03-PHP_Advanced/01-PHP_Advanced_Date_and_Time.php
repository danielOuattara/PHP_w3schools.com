...
--------------------------------------------------------------
format 	    Required. Specifies the format for the timestamp
...
the characters to add additional formatting.
...
Example -->
  ...
  <!-- PHP Tip - Automatic Copyright Year Update
=================================================
...
Example -->
  ...
  <!--
Note : PHP date() function will return the current date/time of the server!


Get Your Time Zone
====================

If the time you got back from the code is not correct, it's probably 
...
The example below sets the timezone to "America/New_York", then outputs 
...
====================================
  ...
  The optional timestamp parameter in the date() function specifies 
  a timestamp. If omitted, the current date and time will be used,
  as in the examples above.

  The PHP mktime() function returns the Unix timestamp for a date. 
  The Unix timestamp contains the number of seconds between the 
  ...
  The example below creates a date and time with the date() function 
  from a number of parameters in the mktime() function:
  ...
  date string into a Unix timestamp, the number of seconds since January 
  1 1970 00:00:00 GMT.
  ...
  <!-- However, strtotime() is not perfect, so remember to check 
  the strings you put in there.
