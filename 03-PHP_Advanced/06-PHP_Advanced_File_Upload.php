...
Next, create an HTML form that allow users to choose the image 
...
-------------------------
    ...
    field as a file-select control, with a "Browse" button next to 
    the input control
...
Note: You will need to create a new directory called "uploads" 
----- in the directory where "upload.php" file resides. 
      The uploaded files will be saved there.


Now we can add three 03 restrictions.


1) Check if File Already Exists
   We will check if the file already exists in the "uploads" folder. 
...
2) Limit File Size
   ...
   named "fileToUpload". 
   Now, we want to check the size of the file: if the file 
   is larger than 500KB, an error message is displayed, and 
...
3) Limit File Type:
   The code below only allows users to upload JPG, JPEG, 
   PNG, and GIF files. All other file types gives an error 
   message before setting $uploadOk to 0:
-------------------------------------------------------->
  <?php
