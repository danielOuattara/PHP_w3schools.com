...
with the value "John Doe". The cookie will expire 
after 30 days (86400 * 30). The "/" means that the 
cookie is available in entire website (otherwise, 
select the directory you prefer).

We then retrieve the value of the cookie "user", using 
the global variable $_COOKIE. We also use the isset() 
...
-------->
  ...
  setcookie($cookie_name, $cookie_value, $expire, $path); // 86400 = 1 day
  ?>
...
For a complete reference of Network functions, go to our 
complete PHP Network Reference.-->
