...
<body>
  ...
  <!-- The 'include' or 'require' statement takes all 
  the text/code/markup that exists in the specified file 
  and copies it into the file that uses the include/require statement.
...
even if the outdoor file is missing, use the 'include' statement. 
...
This will help avoid compromising your application's security and 
...
Example 1: Assume we have a standard footer file called "footer.php", 
...
Here is how it can be done: we are using a <div> element 
...
Example 3: Assume we have a file called "vars.php", with some variables defined:
----------
...
The 'require' statement is also used to include 
a file into the PHP code.

However, there is one big difference between include 
and require: when a file is included with the include 
...
script execution dies after the require statement 
