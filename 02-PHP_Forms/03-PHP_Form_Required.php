...
This chapter shows how to make input fields required and create 
...
From the validation rules table on the previous page, we see that 
the "Name", "E-mail", and "Gender" fields are required. 
...
function). If it is empty, an error message is stored in the different 
error variables, and if it is not empty, it sends the user input data 
...
"Does the Name field contain only letters and whitespace?", 
